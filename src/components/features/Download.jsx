...
const Download = () => {
  return (
    <div className="relative top-[33rem] mb-[10rem] bg-gradient-to-r from-primaryColor to-cyan-500 w-full p-[2rem] flex flex-1 flex-wrap justify-between items-center shadow-2xl">
